...
class User(BaseModel, Base):
    ...
    location = Column(String(255), nullable=False, default='NAIROBI, KENYA')
    ...
    # The relationship to the accounts table
    accounts = relationship("Accounts", uselist=False, back_populates="user")

    # The relationship to the transactions table
    ...
    # The relationship to the messages table
